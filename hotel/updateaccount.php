...
<th style='height:30px;	color:#000;	font-weight:bold;background-color:#000;'><font color='white' size='2'>Edit</th>
</tr>  
<?php
...
<td><?php echo $password;?></td>	
						<?php
						print("<td style='height:30px;'><a href = 'editaccount.php?idno=".$ctrl."'><img src = 'image/edit.jpg' width='15px' height='15px' title='Edit' ></img></a></td>
		");?>
