...
<script>
  function isdelete()
  {
   ...
   if(!d)
   {
    alert(window.location='mcomments.php');
   }
   else
   {
   return false;
...
<div id="Menus">		
		<ul>
			...
			<li class="active"><a href="mcomments.php">Comments</a></li>
...
<br><br>
<center><h3>Available comments</h3></center>
            <?php
  ...
  print ("<tr>");
	 print ("<td><font size='2'>" . $row['name'] . "</td>");
	  ...
	  print ("<td><font size='2'>" . $row['message'] . "</td>");		
		print("<td align = 'center' width = '1'><a href = 'deletecomms.php?key=".$ctrl."'><img width='35px' height='25px' src = 'image/wrong.png' title='Delete' onclick='isdelete();'></img></a></td>
		");
  print ("</tr>");
  }
print( "</table>");
